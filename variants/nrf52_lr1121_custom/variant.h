...
#define PIN_SPI_MISO            (36)            // P1.04
#define PIN_SPI_MOSI            (11)            // P0.11
#define PIN_SPI_SCK             (32)            // P1.00
#define PIN_SPI_NSS             (38)            // P1.06

////////////////////////////////////////////////////////////////////////////////
// Builtin LEDs

#define LED_BUILTIN             (-1)
#define LED_BLUE                (15)            // P0.15
#define LED_GREEN               (-1)
...
#define LORA_DIO_1              (20)            // P0.20 - DIO7
#define LORA_DIO_2              (17)            // P0.17 - DIO8
#define LORA_NSS                (38)            // P1.06
#define LORA_RESET              (22)            // P0.22
#define LORA_BUSY               (24)            // P0.24
#define LORA_SCLK               (32)            // P1.00
#define LORA_MISO               (36)            // P1.04
#define LORA_MOSI               (11)            // P0.11
#define LORA_DIO3               (9)             // P0.09 - DIO9
